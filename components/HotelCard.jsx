...
//we will map the array in the form of cards soo that the cards are clickable
//this time we will not map the array rat
const HotelCard = ({room,idx}) => {//object destructing in the form of props we will receive the roomnp. andidx
  return (
   ...
   { idx%2===0 &&<p className='px-3 py-1 absolute top-3 left-3 text-xs bg-white text-gray-800 font-medium rounded-full'>Best Seller</p>}
   
    <div className='p-4 pt-5'>
        <div classNmae='flex items-center justify-between'>
